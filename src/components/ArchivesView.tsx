    ...
    <div id="archives-view" className="p-8 max-w-7xl mx-auto space-y-8 bg-slate-50 min-h-full">
      <header className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold uppercase tracking-widest text-slate-600 hover:bg-slate-50 shadow-sm">
            <History className="w-3.5 h-3.5" />
            Restore Point
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-slate-800 shadow-lg shadow-slate-900/20">
            Snapshot State
          </button>
        </div>
      </header>
