  ...
  return (
    <div id="sales-view" className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 transition-all focus-within:border-indigo-300">
        ...
        <div className="flex bg-slate-50 p-1 rounded-xl border border-slate-200">
           {['all', 'confirmed', 'shipped', 'cancelled'].map(s => (
             <button 
               key={s}
